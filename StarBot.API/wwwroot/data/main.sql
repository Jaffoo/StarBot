...
INSERT INTO "SysConfig" VALUES (45, 11, 'MsgTypeAll', '所有消息类型', '[{"name":"文本消息","value":"text"},{"name":"图片消息","value":"image"},{"name":"表情消息","value":"EXPRESSIMAGE"},{"name":"视频消息","value":"video,VIDEO"},{"name":"音频消息","value":"audio,AUDIO"},{"name":"回复消息","value":"REPLY"},{"name":"礼物回复消息","value":"GIFTREPLY"},{"name":"计分消息","value":"fen"},{"name":"开播","value":"LIVEPUSH"},{"name":"房间电台","value":"TEAM_VOICE"},{"name":"开播/房间电台艾特全体成员","value":"AtAll"},{"name":"文字翻牌","value":"FLIPCARD"},{"name":"语音翻牌","value":"FLIPCARD_AUDIO"},{"name":"视频翻牌","value":"FLIPCARD_VIDEO"},{"name":"礼物消息","value":"PRESENT_NORMAL"}]', NULL, 'list');
...
INSERT INTO "SysConfig" VALUES (71, 11, 'SaveMsg', '保存消息', '0', '0-不保存，1-小偶像消息，2-全部消息', 'int');
