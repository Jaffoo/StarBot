...
namespace StarBot.DeskServer.WebViewHost.WebView2Host
{
    internal class WebView2 : IWebView
    {
            ...
            string blazorSelector)
        {
            ...
            await CoreWebView2Controller.CoreWebView2.AddScriptToExecuteOnDocumentCreatedAsync($"sessionStorage.setItem('HttpPort',{post})");
            //屏蔽快捷键
